...
import pandas as pd
import torch
from hanziconv import HanziConv  #繁体中文字体转换
...
def build_vocab(train_dir, vocab_size=5000):
    ...
    open_file('data/vocab.txt', mode='w').write('\n'.join(words) + '\n') # 构建字典vocab.txt

if __name__ == '__main__':
    build_vocab(r'data\atec_nlp_sim_train_all.csv')

    train_data = LCQMC_Dataset(r"./data/atec_nlp_sim_train_all.csv", r"./data/vocab.txt", 50)
